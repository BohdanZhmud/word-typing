...
let platformTool tool winTool =
    ...
    match tryFindFileOnPath tool with
    | Some t -> t
...
Target "InstallDotNetCore" 
    (fun _ -> dotnetCli <- DotNetCli.InstallDotNetSDK dotnetcliVersion)
...
Target "RestoreServer" (fun () -> run dotnetCli "restore" serverPath)
Target "Build" (fun () -> 
...
Target "Docker" (fun _ -> 
    ...
    run "docker" tagArgs ".")
"Clean" ==> "InstallDotNetCore" ==> "InstallClient" ==> "Build" ==> "Bundle" 
==> "Docker"
"InstallClient" ==> "RestoreServer" ==> "Run"
